...
from geothermal.active_learning_utils import (
    decode_h5_scalar as _decode_h5_scalar,
    read_geology_metadata as _read_geology_metadata,
    jl_quote as _jl_quote,
    sanitize_id_token as _sanitize_id_token,
    to_julia_wells_text as _to_julia_wells_text,
)
...
def main() -> None:
    ...
    output_root = (
        ...
        if args.output_dir
        else _resolve_config_path(config.get("output_root", "inference_outputs/cmaes_active_learning"))
    )
