...
def main() -> None:
    ...
    print(
        f"Generating {num_samples_N} LHS starting configurations for {num_wells} wells..."
    )
    ...
    for i in range(num_samples_N):
        ...
        for w in range(num_wells):
            ...
            rand_y = y_min_bound + lhs_samples[i, w * 2 + 1] * (
    ...
    ax_energy1.set_title(
        f"Energy Traces across {num_samples_N} LHS Samples",
        fontsize=TITLE_SIZE,
        color=MANIM_WHITE,
    )
